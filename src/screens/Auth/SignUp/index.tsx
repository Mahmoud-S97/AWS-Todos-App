    ...
    <ScrollView className="flex-1 bg-primary-light dark:bg-primary-dark" showsVerticalScrollIndicator={false}>
      <MainHeader>
        <TouchableOpacity activeOpacity={0.6} onPress={goBack}>
          <AppIcon name='chevron-left' size={27} className='text-text-dark dark:text-text-light mt-[5]' />
        </TouchableOpacity>
      </MainHeader>
      <View className='flex-1 items-center justify-center'>
        <View className='w-[95%] h-full pb-[40] self-center mt-[100] items-center justify-center'>
          <Text className='text-3xl text-text-dark dark:text-text-light font-bold mb-[40]'>Sign Up to Continue!</Text>
          <TextInput
          ...
          />
          <MainButton style={[APP_THEME.mainShadow, { borderWidth: 1 }]} className='w-[96%] self-center my-[15] bg-primary-default border border border-gray-400 dark:border-gray-700 rounded-lg' textClassName='text-xl text-gray-900' onPress={SignUpHandler}>
            Sign Up
          </MainButton>
          ...
          <MainButton style={[APP_THEME.mainShadow, { borderWidth: 1 }]} className='w-[96%] self-center my-[15] bg-background-googleButton border border border-gray-400 dark:border-gray-700 rounded-lg' textClassName='text-xl text-white' icon={{ name: 'google-plus', className: 'text-white me-3' }} onPress={SignUpWithGoogle}>
            Continue with Google
          </MainButton>
          <Text className='text-l text-text-dark dark:text-text-light mt-[20]' onPress={() => navigation.popTo('Login')}>Have an account? <Text className='text-l text-primary-default font-bold'>Login</Text></Text>
        </View>
      </View>
    </ScrollView>
  )
